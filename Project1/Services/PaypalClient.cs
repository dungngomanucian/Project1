...
namespace Project1.Services
{
    public sealed class PaypalClient
    {
        ...
        public async Task<RefundResponse> RefundPayment(string captureId, string amount, string currency)
        {
            var auth = await Authenticate();
            ...
            {
                throw new Exception($"Refund failed: {httpResponse.ReasonPhrase}");
            }
